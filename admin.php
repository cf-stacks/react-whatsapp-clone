...
<head>
    ...
    <title>
        ...
        <?php echo !$is_cloud && $connection_success && sb_get_setting('admin-title') ? sb_get_setting('admin-title') : ($is_cloud ? SB_CLOUD_BRAND_NAME : 'Leadsto - custom chat') ?>
    </title>
...
<body>
    ...
    sb_component_admin();
    ?>
<script>const beamsClient = new PusherPushNotifications.Client({instanceId: '93a5c661-17e3-4407-a128-12c50715c466',});
