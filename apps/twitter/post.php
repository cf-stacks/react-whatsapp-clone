...
if (isset($response['direct_message_events'])) {
    ...
    // Send message
    if ($is_agent) {
        $last_message = sb_get_last_message($conversation_id, false, sb_get_bot_id());
        ...
        $response_extarnal = sb_messaging_platforms_functions($conversation_id, $message, $attachments, $user, ['source' => 'tw', 'twitter_id' => $sender_id]);
