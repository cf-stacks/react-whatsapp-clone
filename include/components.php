...
function sb_login_box() { ?>
    <form class="sb sb-rich-login sb-admin-box">
        ...
        <div class="sb-top-bar">
            ...
            <div class="sb-text"><?php echo sb_get_setting('login-message', defined('SB_WP') ? sb_('Please insert email and password of your WordPress account') : sb_('To continue to') . ' Leadsto chat') ?></div>
        </div>
        <div class="sb-main">
        ...
        <div class="sb-main sb-scroll-area">
            <div class="sb-bottom">
                <a class="sb-update sb-btn sb-icon">
                 ...
                 <a href="#" target="_blank" class="sb-btn-text">
    ...
    <div class="sb-lightbox sb-direct-message-box">
        ...
        <div class="sb-main sb-scroll-area">
            ...
            <div class="sb-bottom">
                ...
                <div></div>
                <?php if (!defined('SB_CLOUD')) echo '<a class="sb-btn-text" target="_blank" href="#"><i class="sb-icon-help"></i></a>' ?>
        ...
        <div class="sb-header">
            ...
            <div class="sb-admin-nav-right sb-menu-mobile">
                ...
                <div class="sb-desktop">
                    ...
                    <?php if ($is_admin && (!$is_cloud || defined('SB_CLOUD_DOCS'))) echo '<a href="' . ($is_cloud ? SB_CLOUD_DOCS : 'https://chat.leadsto.link/admin.php') . '" target="#" class="sb-docs"><i class="sb-icon-help"></i></a><a href="#" class="sb-version">' . SB_VERSION . '</a>' ?>
                </div>
                <div class="sb-mobile">
                ...
                <div class="sb-top-bar">
                    <div>
                        ...
                        <div class="sb-menu-mobile">
                            ...
                            <ul>
                                 <li>
                                     <a class="sb-btn-icon sb-new-user" style="border-radius: 50px;" data-sb-tooltip="<?php sb_e('Add new user') ?>"><i class="sb-icon-user"></i>
                                     </a>
