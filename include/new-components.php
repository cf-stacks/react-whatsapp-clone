    ...
    <div class="sb-lightbox sb-direct-message-box">
        ...
        <div class="sb-main sb-scroll-area">
            ...
            <div class="sb-bottom">
                ...
                <div></div>
                <?php if (!defined('SB_CLOUD')) echo '<a class="sb-btn-text" target="_blank" href="https://t.me/leadsto_bot"><i class="sb-icon-help"></i></a>' ?>
        ...
        <div class="sb-header">
            ...
            <div class="sb-admin-nav-right sb-menu-mobile">
                ...
                <div class="sb-desktop">
                    ...
                    <?php if ($is_admin && (!$is_cloud || defined('SB_CLOUD_DOCS'))) echo '<a href="' . ($is_cloud ? SB_CLOUD_DOCS : 'https://t.me/leadsto_bot') . '" target="_blank" class="sb-docs"><i class="sb-icon-help"></i></a><a href="#" class="sb-version">' . SB_VERSION . '</a>' ?> 
                </div>
                <div class="sb-mobile">
